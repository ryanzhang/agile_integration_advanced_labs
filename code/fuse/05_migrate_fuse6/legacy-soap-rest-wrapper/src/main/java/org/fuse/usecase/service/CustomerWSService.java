...
public class CustomerWSService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:9090/ws/customerService?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CustomerWSService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:9090/ws/customerService?wsdl");
        }
        WSDL_LOCATION = url;
    }
